...
riscv64-unknown-elf-gcc -O3 -fno-common -o precomp.o -c precomp.c

#asm
riscv64-unknown-elf-gcc -O3 -fno-common -o ntt.o -c ntt_1.S
riscv64-unknown-elf-gcc -O3 -fno-common -o invntt.o -c invntt_1.S
