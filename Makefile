...
COMMONSOURCES=mupq/common/fips202.c mupq/common/sha2.c mupq/pqclean/common/aes.c mupq/common/sp800-185.c
COMMONSOURCES_HOST=$(COMMONSOURCES) mupq/common/keccakf1600.c
COMMONSOURCES_RISCV=$(COMMONSOURCES) common/keccakf1600.c #common/keccakf1600_asm.S
